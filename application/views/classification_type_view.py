...
@classification_type_view.route('/classificationtypes/<classification_type>', methods=['POST'])
@auth.login_required
...
@classification_type_view.route('/classificationtypes/<classification_type>', methods=['DELETE'])
@auth.login_required
