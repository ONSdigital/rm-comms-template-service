from application.controllers.classification_type_controller import ClassificationTypeController, UPLOAD_SUCCESSFUL
...
class TestTemplateController(TestClient):
    ...
    def test_upload_existing_classification_type_raises_invalid_classification_type_exception(self):
        ...
        with self.assertRaises(InvalidClassificationType):
            ClassificationTypeController.upload_classification_type(classification_type)
